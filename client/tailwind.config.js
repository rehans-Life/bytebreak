  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'dark-hover': 'rgb(60, 60, 60)',
        'dark-button': '#ffffff1a',
        'dark-shadow': "rgba(200, 200, 230, 0.1)",
